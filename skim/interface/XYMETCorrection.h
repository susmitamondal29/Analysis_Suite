#ifndef XYMETCORRECTION_H_
#define XYMETCORRECTION_H_
...
std::pair<double,double> METXYCorr_Met_MetPhi(double uncormet, double uncormet_phi, int runnb, std::string year, bool isMC, int npv, bool isUL =true, bool ispuppi=false){
    ...
    if(CorrectedMET_x==0 && CorrectedMET_y>0) CorrectedMETPhi = M_PI;
    else if(CorrectedMET_x==0 && CorrectedMET_y<0 )CorrectedMETPhi = -M_PI;
    else if(CorrectedMET_x >0) CorrectedMETPhi = std::atan(CorrectedMET_y/CorrectedMET_x);
    else if(CorrectedMET_x <0&& CorrectedMET_y>0) CorrectedMETPhi = std::atan(CorrectedMET_y/CorrectedMET_x) + M_PI;
    else if(CorrectedMET_x <0&& CorrectedMET_y<0) CorrectedMETPhi = std::atan(CorrectedMET_y/CorrectedMET_x) - M_PI;
